...
const Homeblog = () => {
	...
	<div class="container">	
		...
		<div class="witr_blog_area11 witr_blog_area16">
			<div class="blog_wrap blog16_idblog1 blog_top row">
	
				<div class="witr_all_mb_30 col-lg-4 ">
					<div class="busi_singleBlog">
						...
						<div class="all_blog_color">	
							<div class="witr_blog_con bs5">									
								<h2><Link to="#">Boost Leads Optimize Market New Year</Link></h2>
				...
				<div class="witr_all_mb_30 col-lg-4">
					<div class="busi_singleBlog">
						...
						<div class="all_blog_color">	
							<div class="witr_blog_con bs5">									
								<h2><Link to="#">We make a Revolution in Word Class Building.</Link></h2>
								<p>Lorem Ipsum has been the industry's standarddummy text ever since this</p>
								<div class="em-blog-content-area_adn ">
									<div class="learn_more_adn">
										<Link class="learn_btn adnbtn2" to="#">Read More </Link>
				...
				<div class="witr_all_mb_30 col-lg-4">
					<div class="busi_singleBlog">
						...
						<div class="all_blog_color">	
							<div class="witr_blog_con bs5">									
								<h2><Link to="#">Which Architecture sheet tool is to choose?</Link></h2>
								<p>Lorem Ipsum has been the industry's standarddummy text ever since this</p>
								<div class="em-blog-content-area_adn ">
									<div class="learn_more_adn">
										<Link class="learn_btn adnbtn2" to="#">Read More </Link>
				...
				<div class="witr_all_mb_30 col-lg-4">
					<div class="busi_singleBlog">
						...
						<div class="all_blog_color">	
							<div class="witr_blog_con bs5">									
								<h2><Link to="#">Questions every business owner able to answer</Link></h2>
								<p>Lorem Ipsum has been the industry's standarddummy text ever since this</p>
								<div class="em-blog-content-area_adn ">
									<div class="learn_more_adn">
										<Link class="learn_btn adnbtn2" to="#">Read More </Link>
